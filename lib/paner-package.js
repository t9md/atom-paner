  ...
  activate() {
    ...
    this.subscriptions.add(
      atom.commands.add("atom-workspace", {
        ...
        "paner:split-pane-down-keep-active-pane": () =>
          this.splitPane("Down", {keepActivePane: true}),
        "paner:split-pane-left-keep-active-pane": () =>
          this.splitPane("Left", {keepActivePane: true}),
        "paner:split-pane-right-keep-active-pane": () =>
          this.splitPane("Right", {keepActivePane: true}),
